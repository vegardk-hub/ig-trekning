...
- **[Prisme (V2)](visualizer/v2/)** — `visualizer/v2/index.html`: én
  visualisering i WebGL — glasskule med ringer i bane, ekte lysbrytning og
  stillbilder i 4K.
...
- **[Ukens poengtavle](pwa-poengtavle/)** — `pwa-poengtavle/index.html`:
...
- **[Koordinatjakt](koordinatjakt/)** — `koordinatjakt/index.html`: lager
  ...
  en liste koordinater og sier eller skriver hva som står i hver rute — i
  feltene på iPaden, i mikrofonen, eller med blyant på et utskrevet ark.
  Svarene godtas i bestemt form og med én skrivefeil, for det er koordinater
  som øves, ikke rettskriving.
